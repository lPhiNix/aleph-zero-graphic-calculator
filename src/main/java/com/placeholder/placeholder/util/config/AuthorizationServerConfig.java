...
import com.placeholder.placeholder.util.OAuth2RedirectAuthenticationSuccessHandler;
...
public class AuthorizationServerConfig {
    ...
    @Bean
    public AuthenticationSuccessHandler authenticationSuccessHandler(RegisteredClientRepository repo) {
        return new OAuth2RedirectAuthenticationSuccessHandler(repo, "react-client");
    }
}
